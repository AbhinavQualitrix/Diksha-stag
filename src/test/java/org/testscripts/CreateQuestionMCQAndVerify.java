...
public class CreateQuestionMCQAndVerify extends BaseTest {
	
	@Test
	public void createQuestionMCQAndVerify() throws Exception
	{
		...
		creatorUserPageObj.createQuestionMCQ(objListOFTestDataForSunbird);
