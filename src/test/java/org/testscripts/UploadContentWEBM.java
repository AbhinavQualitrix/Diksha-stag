...
* Purpose: As a Creator Upload WEBM,as a Reviewer Publish it and as a User Consume it.
...
public class UploadContentWEBM extends BaseTest
{
	@Test
	public void uploadContentWEBM() throws Exception
	{
		...
		creatorUserPageObj.uploadContent(WEBM);
