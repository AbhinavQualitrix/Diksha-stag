...
* Purpose: All the locators of user page.
*/
package org.page;
...
//	@FindBy(xpath="//div//a[5][contains(text(),'Profile')]")
	...
	public WebElement clickLanguageFilter;
	
	@FindBy(xpath="//sui-multi-select[@id='board']//i[@class='dropdown icon']")
	public WebElement clickBoardFilter;
	
	@FindBy(xpath="//sui-multi-select[@id='medium']//i[@class='dropdown icon']")
	public WebElement clickMediumFilter;
	
	@FindBy(xpath="//input[contains(text(),'Concepts ')]")
	public WebElement clickConcepts;
	
	@FindBy(xpath="//div//span[.='Environmental Studies']")
	public WebElement selectFilterLanguage;
	
	@FindBy(xpath="//div//span[.='MSCERT']")
	public WebElement selectFilterBoard;
	
	@FindBy(xpath="//div//span[.='English']")
	...
	@FindBy(xpath="//sui-multi-select//span[.='Kannada']")
	...
	//Added for Test case 13 - 23/08/2018
	@FindBy(xpath="//a[.='Last']")
