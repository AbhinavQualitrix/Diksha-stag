...
public class CreateMentorPage {
	...
	//@FindBy(xpath="//div[@data-value='b28661ad-385c-4c9f-970c-4763df7220f5']")
	@FindBy(xpath="//div[@data-value='bcbe745a-5f8f-4ee8-80c2-597c717641c0']")
	public WebElement subOrgUserSun6;
	
	@FindBy(xpath="//div[@data-value='1d252488-4c31-4802-8263-6079fc7b2af5']")
	public WebElement subOrgMentorDiksha2;
	
	@FindBy(xpath="//div[@data-value='5372024a-50aa-408e-968d-75599581b402']")
	public WebElement subOrgUserDiksha6;
	...
	//@FindBy(xpath="//div[@data-value='4b3c6d5b-22af-4b2b-b141-6e050bbb123d']")
	@FindBy(xpath="(//div[text()=' Jayaprakash N (ja*********@nurture.co.in, ******3518) '])[1]")
	public WebElement jayprakashN;
	
	//@FindBy(xpath="//div[@data-value='4b3c6d5b-22af-4b2b-b141-6e050bbb123d']")
	@FindBy(xpath="//div[text()=' Demo Public (de********@ekstep.org) ']")
	public WebElement demoPublic;
	...
	//@FindBy(xpath="(//div[@data-value='f4d2bb4a-7513-47c2-b677-4a68d072696d'])[1]")
	@FindBy(xpath="(//div[contains(text(),'mentor mentor')])[1]")
	public WebElement mentor_mentor;
	
	@FindBy(xpath="(//div[contains(text(),'publicuser mentior')])[1]")
	public WebElement publicUser;
	
	@FindBy(xpath="(//div[contains(text(),'content reviewer')])[1]")
	public WebElement content_reviewer;
}