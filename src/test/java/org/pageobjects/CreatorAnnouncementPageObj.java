...
* Purpose: All the reusable methods for Announcement page.
*/
...
public class CreatorAnnouncementPageObj extends BaseTest{
	...
	public void CreateAnnouncement() throws InterruptedException, Exception
	{
			...
			createAnnouncementPage.enterOrg.sendKeys(objListOFTestDataForSunbird.get(7).getCourseDescription()+ announcementNumber);
